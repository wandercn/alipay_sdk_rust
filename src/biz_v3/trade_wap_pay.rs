...
pub struct TradeWapPayV3Biz(BizObjectV3);

impl BizContenterV3 for TradeWapPayV3Biz {
    fn path(&self) -> String {
        "/v3/alipay/trade/wap/pay".to_string()
    }
...
impl TradeWapPayV3Biz {
    ...
    pub fn set_quit_url(&mut self, value: V3) {
